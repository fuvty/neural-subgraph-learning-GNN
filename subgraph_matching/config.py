...
def parse_encoder(parser, arg_str=None):
    ...
    enc_parser.add_argument('--edge_attr', action="store_true")
    ...
    enc_parser.set_defaults(conv_type='SAGE',
                        ...
                        eval_interval=1000,
                        n_workers=4,
                        # model_path="/home/futy18/nfs/repos/prime/NIPS22/DeSCo/ckpt/neighborhood/sage_tconv_main.ckpt",
                        model_path="ckpt/model_test.pt",
                        tag='',
                        val_size=4096,
                        node_anchored=True)
